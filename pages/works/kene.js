    ...
    <Layout url={url} title="jeojoe | kene.co.th" subHeader="Works">
      <div className="blog">
        <Header
          ...
          tags={work.tags}
        />
        <p>KENE Laboratory Co., Ltd. is skincare brand i've done with my friend since freshman year. kene.co.th is brand's e-commerce website that me and 2 of my engineering olympiad-genius-level friends team up building it together in junior year.</p>
