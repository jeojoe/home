  ...
  return (
    <Layout url={url} title="jeojoe | Web Programming Assignment" subHeader="Works">
      <div className="blog">
        ...
        <a href="https://github.com/jeojoe/web-prog" target="_blank" rel="noopener noreferrer">Web Prog Repository (Warning: political sacastic jokes are strong with resume work !!)</a>
      </div>
    </Layout>
  );
};
