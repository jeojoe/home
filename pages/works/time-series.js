...
export default ({ url }) => {
  ...
  return (
    <Layout url={url} title="jeojoe | Yo Time Series Mining" subHeader="Works">
      <div className="blog">
        <Header
          name={work.name}
          date={work.date}
        ...
        <p>The project we did is in Github repo, yo.</p>
        <a href="https://github.com/jeojoe/yo-time-series" target="_blank" rel="noopener noreferrer">Time Series Project Repository</a>
      </div>
    </Layout>
  );
};
