  ...
  return (
    <Layout url={url} title="jeojoe | emplist.com" subHeader="Works">
      <div className="blog">
        ...
        <p>Me and <a href="https://github.com/aunnnn" target="_blank" rel="noopener noreferrer">my friend</a> implemented this using MERN.io. By that time it was not in active development anymore but we found that this is the most understandable React boilerplate out there. Others are too complicated.</p>
        <p>This site is built on React, Redux, Express.js and MongoDB.</p>
        <a href="https://emplist.com/" target="_blank" rel="noopener noreferrer">www.emplist.com</a>
      </div>
    </Layout>
  );
};
