  ...
  return (
    <Layout url={url} title="jeojoe | Shills.lol" subHeader="Works">
      <div className="blog">
        ...
        <p>Late 2017 and early 2018 was a weird time when shills plagued <a href="https://www.reddit.com/r/CryptoCurrency">/r/CryptoCurrency</a>. So me and <a href="https://github.com/aunnnn" target="_blank" rel="noopener noreferrer">my friend</a> has an idea for a place dedicated to shills! It exploded for a week then faded away though. But at least we had some really good shills that made us laugh.</p>
