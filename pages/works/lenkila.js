...
export default ({ url }) => {
  ...
  return (
    <Layout url={url} title="jeojoe | Lenkila" subHeader="Works">
      <div className="blog">
        <Header
          name={work.name}
          date={work.date}
        ...
        <p>This site is built on Next.js.</p>
        <a href="https://lenkila.com" target="_blank" rel="noopener noreferrer">lenkila.com</a>
      </div>
    </Layout>
  );
};
