  ...
  return (
    <Layout url={url} title="jeojoe | SANSIRI HomeService" subHeader="Works">
      <div className="blog">
        ...
        <p>The app is on both <a href="https://play.google.com/store/apps/details?id=com.homeservice&hl=en" target="_blank">App Store</a> and <a href="https://itunes.apple.com/th/app/home-service/id624978116?mt=8" target="_blank">Play Store</a>.</p>
      </div>
    </Layout>
  );
};
