    ...
    <Layout url={url} title="jeojoe | SANSIRI HomeService" subHeader="Works">
      <div className="blog">
        <Header
          ...
          tags={work.tags}
        />
        <p>At final year in university, i decided to work part-time at software consulting company. i worked on SANSIRI's product called Home Service, the application for your home and your smart living. i was assigned to do backend programming, API Refactoring from legacy code (from plain PHP files to Laravel Framework), Relational Database Design (MySQL) and also associated project management.</p>
