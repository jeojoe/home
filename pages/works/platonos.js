    ...
    <Layout url={url} title="jeojoe | platonos.com" subHeader="Works">
      <div className="blog">
        <Header
          ...
          tags={work.tags}
        />
        <p>Me and <a href="https://github.com/aunnnn" target="_blank">my friend</a> want to build a place where people can discuss about serious topics like science, art, philosophy, etc. Enable them to connect and get to know each others.</p>
