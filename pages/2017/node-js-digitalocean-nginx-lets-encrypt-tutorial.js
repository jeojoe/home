...
export default ({ url }) => {
  ...
  return (
    <Blog url={url} thought={thought} subHeader="Thoughts">
      <p>What the fuck.</p>
      <p>Why the actual fuck it took me so long to do my first fucking Node.js app deployment. Why the fuck i had to open 20 tabs to learn why the fuck it crashed and still had to delete my droplet and start it all over again.</p>
